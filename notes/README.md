...
| [Initial spike](2026-09-06-atseq-initial-spike.md) | S0–S1 landed; S2 awaiting review; S3–S6 not started | Work packages, critical UI flows, and acceptance gates |
...
| [PDS spike](2026-09-06-atseq-pds-spike.md) | S2 gate passes; awaiting review | Real PDS appends, crash recovery, source retention and verified catch-up |
