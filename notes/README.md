...
| [Initial spike](2026-09-06-atseq-initial-spike.md) | S0–S2 landed; S3 awaiting review; S4–S6 not started | Work packages, critical UI flows, and acceptance gates |
...
| [Definition and runtime spike](2026-09-06-atseq-runtime-spike.md) | S3 gates pass; awaiting review | Retained source closure, fold/query behavior, atomic projections and late-loaded apps |
